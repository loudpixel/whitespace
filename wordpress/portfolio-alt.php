<?php
/**
 * Template Name: Alternate Portfolio Page
 *
 * Special template for additional slider-enabled WordPress pages
 */
?>
<?php get_header(); ?>
<section id="content">
		...
		<section id="showcase">
			<div id="nivo-slider">
				...
				foreach ( (array) $homepage_gallery_images as $attachment_id => $attachment ) {
					if (preg_match("/\bportfolio-alt\b/i", $attachment->post_excerpt)) {
